...
const SobreImage = styled('img')({
    width: '300px', // Imagem ocupará 100% da largura do container
    ...
    return (
        <div>
            ...
            <SobreContainer>
                ...
                Espero poder ajudar você a contar sua história única por meio da arte da tatuagem. Junte-se a mim nesta jornada criativa!</p>
            </SobreContainer>
            <Footer/>
        </div>
    );
